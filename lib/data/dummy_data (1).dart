...
// 🔥 هنا خليت نفس الوجبات اللي عندك
const dummyMeals = [
  Meal(
    id: 'm1',
    categories: ['c1', 'c2'],
    ...
    duration: 20,
    ingredients: ['4 Tomatoes', '1 Onion', '250g Spaghetti', 'Spices'],
    steps: [
      'Cut the tomatoes and onion',
      'Boil water with salt',
      'Cook spaghetti for 10-12 minutes',
  ...
  // 👉 أضف باقي الوجبات اللي عندك زي ما هي
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/2017/05/12/17/54/avocado-2308425_1280.jpg',
    duration: 10,
    ingredients: [
    ...
    steps: [
      ...
      'Add optional fried eggs on top',
    ],
    isGlutenFree: false,
    isVegan: true,
    isVegetarian: true,
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/2016/03/05/20/07/barbecue-1239434_1280.jpg',
    duration: 30,
    ingredients: [
      '500g Ground Beef',
      '4 Burger Buns',
    ...
    steps: [
      'Form beef patties',
      'Grill patties for 5-6 minutes each side',
      'Toast burger buns',
      'Assemble burgers with toppings',
      'Add BBQ sauce and cheese',
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
  ...
  Meal(
    ...
    complexity: Complexity.challenging,
    imageUrl:
        'https://cdn.pixabay.com/photo/2018/05/20/17/47/beef-3415770_1280.jpg',
    duration: 180,
    ingredients: [
      '1kg Beef Chuck',
      '200g Bacon',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/2017/09/23/12/34/bratwurst-2778745_1280.jpg',
    duration: 25,
    ingredients: [
    ...
    steps: [
      ...
      'Add sauerkraut and caraway',
      'Simmer for 15 minutes',
      'Serve sausages with sauerkraut',
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: false,
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/2017/05/13/21/51/breakfast-2310811_1280.jpg',
    duration: 10,
    ingredients: [
      '2 Frozen Bananas',
      '100g Frozen Berries',
